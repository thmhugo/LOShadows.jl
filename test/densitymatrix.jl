@testset "testing DensityMatrix constructor" begin
    ...
    wrong_dim_rho = Matrix{ComplexF64}(I, 3, 3) * 1 / d

    good_rho = Matrix{ComplexF64}(I, d, d) * 1 / d

    nonpsd_rho = -1 * Matrix{ComplexF64}(I, d, d) * 1 / d
    # nonnormalised_rho = Matrix{ComplexF64}(I, d, d)
    nonselfadjoint_rho = Matrix{ComplexF64}(I, d, d) * 1 / d
